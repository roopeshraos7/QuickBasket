...
|                    `interface ProductProvider` (Strategy)                          |
+------------------------------------------+-----------------------------------------+
             ...
             v                                                           v
+--------------------------+                                +--------------------------+
| QuickCommerceApiProvider |                                |   MockProductProvider    |
| (RestClient + Timeouts)  |                                |  (Offline Dev & Test)    |
+------------+-------------+                                +------------+-------------+
             |                                                           |
             v                                                           v
+--------------------------+                                +--------------------------+
|  Quick-Commerce Aggregated|                                |  Mock E-Commerce / QC    |
| (Blinkit, Zepto, Instamart)                                | (Offline Sample Datasets)|
+--------------------------+                                +--------------------------+�──────────────────┬─────────────────────────────────────────┘
                                               │
                                               ▼
    ┌────────────────────────────────────────────────────────────────────────────────────┐
